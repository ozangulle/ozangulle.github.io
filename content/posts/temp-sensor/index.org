...
#+CAPTION: Figure 1: Front side which looks fairly clean
...
#+CAPTION: Figure 2: The back side looks quite sloppy. Also I messed up black/red wires from USB adaptor to voltage regulator.
